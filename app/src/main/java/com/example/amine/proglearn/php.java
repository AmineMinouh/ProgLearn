...
public class php extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comn1 = (EditText) findViewById(R.id.phpcomnter1);
        comnt2 = (EditText) findViewById(R.id.phpcomnter2);
        comnt3 = (EditText) findViewById(R.id.phpcomnter3);
...
//////////////////////////////////////////////////////////////////
        ...
        repance1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s.equals("App_web")){
                    ...
                    Toast.makeText(php.this, " bravo repance just", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(php.this, " repance incorect", Toast.LENGTH_SHORT).show();
                }
    ...
    public void envoyerCmntr1(View view) {
        ...
        if (comnt.equals("")) {
            Toast.makeText(php.this, "virifier champ comnt", Toast.LENGTH_SHORT).show();
        }else{
            boolean result = db.insertcomnt(comnt);
            if (result == true) {
                Toast.makeText(php.this, "insert secsus", Toast.LENGTH_SHORT).show();
                comn1.setText("");
            } else {
                Toast.makeText(php.this, "No insert", Toast.LENGTH_SHORT).show();
            }
        }
    }
