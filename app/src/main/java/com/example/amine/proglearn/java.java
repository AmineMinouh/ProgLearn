...
public class java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comn1 = (EditText) findViewById(R.id.javacomnter1);
        comnt2 = (EditText) findViewById(R.id.javacomnter2);
        comnt3 = (EditText) findViewById(R.id.javacomnter3);
...
//////////////////////////////////////////////////////////////////
        ...
        repance1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s.equals("Programmation")){
                   linearLayout2.setVisibility(linearLayout2.VISIBLE);
                    Toast.makeText(java.this, " bravo repance just", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(java.this, " repance incorect", Toast.LENGTH_SHORT).show();
                }
        ...
        repance2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s.equals("Avant_et_en_cour_d'exécution")){
    ...
    public void envoyerCmntr1(View view) {
        ...
        if (comnt.equals("")) {
            Toast.makeText(java.this, "virifier champ comnt", Toast.LENGTH_SHORT).show();
        }else{
            boolean result = db.insertcomnt(comnt);
            if (result == true) {
                Toast.makeText(java.this, "insert secsus", Toast.LENGTH_SHORT).show();
                comn1.setText("");
             } else {
                Toast.makeText(java.this, "No insert", Toast.LENGTH_SHORT).show();
            }
        }
    }
